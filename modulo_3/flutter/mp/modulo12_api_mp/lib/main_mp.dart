...
// import 'pantalla_paso2_mp.dart';   // ← Paso 2
// import 'pantalla_paso3_mp.dart';   // ← Paso 3
  ...
  Widget build(BuildContext context) {
    const pasos = [
      _PasoInfo(
       ...
       _PasoInfo(
        ruta: '/paso1users',
        titulo: 'Paso 1 Conductores',
        subtitulo: 'Mostrar conductores',
      ...
      _PasoInfo(
        ...
        detalle: 'ViajeDto.fromJson · lista de viajes',
      ...
      _PasoInfo(
        ...
        titulo: 'Paso 2 Users',
        subtitulo: 'Mostrar conductores',
        detalle: 'ConductorDto.fromJson · lista de conductores',
        icono: Icons.directions_bus,
