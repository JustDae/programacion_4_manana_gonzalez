...
class PantallaMetricas extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Estado de la flota de buses'),
        actions: [
          IconButton(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.directions_bus, color: esCritico ? cs.error : cs.primary, size: 18),
            ...
            Text(
              'Capacidad: ${metrica.combustible.toStringAsFixed(0)} GB usados',
              style: TextStyle(fontSize: 12, color: cs.onSurfaceVariant),
            ),
            const SizedBox(height: 10),
            _Barra('Velocidad', metrica.velocidad, cpuCritica),
            const SizedBox(height: 4),
            _Barra('Pasajeros', metrica.pasajeros, ramCritica),
            const SizedBox(height: 4),
